        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h4><a href="{{route('staff.show',[$staff->id])}}">{{$staff->fullname()}}</a>'s Guarantor</h4>
                </div>
                <div class="card-body">
                        <form action="{{route('guarantor.store',[$staff->id])}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="business_adddress">Business Address</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name="employer" id="employer" class="form-control" value="{{old('employer')}}" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="years_with_employer" id="years_with_employer" class="form-control" value="{{old('years_with_employer')}}" >
